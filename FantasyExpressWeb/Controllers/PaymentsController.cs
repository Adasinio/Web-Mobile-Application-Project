...
namespace FantasyExpressWeb.Controllers
{
    public class PaymentsController : Controller
    {
        ...
        public PaymentsController(FantasyExpressDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Payments != null ? 
                          ...
                          Problem("Entity set 'FantasyExpressDbContext.Payments'  is null.");
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Description,IsActive")] Payment payment)
        {
            if (id != payment.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'FantasyExpressDbContext.Payments'  is null.");
            }
            var payment = await _context.Payments.FindAsync(id);
            if (payment != null)
            {
